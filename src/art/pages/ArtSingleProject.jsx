...
export const ArtSingleProject = () => {
  ...
  return (
    <section className="animate-fadeIn font-body flex flex-col gap-10 mb-20">
           <NavLink to={`/art`}>
          <SlArrowLeft className="cursor-hollow pl-2 w-6 h-6 laptop:w-8 laptop:h-6 absolute z-20 top-40 laptop:top-[80%] laptop:left-8 hover:scale-125" />{" "}
        </NavLink>
      <div className="fixed bottom-10 left-4 laptop:left-10 bg-light bg-opacity-80 p-4 rounded-xl w-full laptop:w-[300px]">
