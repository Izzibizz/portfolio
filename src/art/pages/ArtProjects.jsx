...
export const ArtProjects = () => {
    ...
    const image = "https://res.cloudinary.com/dbf8xygxz/image/upload/v1728650485/Izabel_Lind_VR_Oblivion_2020_Konstakademin_nycope.jpg"
    ...
    return (
      <section className="font-body font-medium animate-fadeIn max-w-full overflow-hidden">
      <h2>Art portfolio</h2>
