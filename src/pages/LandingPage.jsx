...
export const LandingPage = () => {
    ...
    return (
        <section className="animate-fadeIn ">
          ...
          <div className={`w-full h-full absolute top-0 left-0 flex flex-col laptop:flex-row justify-center items-center gap-48 tablet:gap-72 laptop:gap-[700px] ${direction === "-translate-x-[90%]" ? "text-black" : "text-white"} `}>
