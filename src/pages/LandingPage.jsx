...
export const LandingPage = () => {
  ...
  return (
    <section className="animate-fadeIn ">
      <Helmet>
        <title>
          Izabel Lind | Creative Frontend Developer & Digital Artist - portfolio
          website
        </title>
        <meta
          name="description"
          content={
            "portfolio for frontend development and artprojects by Izabel Lind"
          }
        />
      </Helmet>
      <video
        ...
        >
          <img
            ...
            className={`relative cursor-hollow laptop:hover:scale-[160%] transform text-center transition-transform duration-500 font-heading text-lg p-4  h-[190px] tablet:h-[240px] ${
              ...
              clickedChoice === "frontend"
                ? "scale-[5000%] duration-[1600ms]"
                : clickedChoice === "art"
                ? "opacity-0"
                : ""
            }`}
