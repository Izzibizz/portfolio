...
export const Contact = () => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Contact Izabel Lind</title>
        <meta name="description" content={"contact info to Izabel Lind"} />
      </Helmet>
      ...
      <div className="flex flex-col w-10/12 laptop:w-8/12 mx-auto pt-8 z-20 font-body font-light">
        <img
          src={
            frontendPortfolioDisplay
              ? "https://res.cloudinary.com/dlp85vjwx/image/upload/v1745309295/contact-white_gs4q08.svg"
        ...
        />
        <hr
          className={`w-full border-t my-4 z-10 ${
            frontendPortfolioDisplay ? "border-light" : "border-black"
          }`}
        />
